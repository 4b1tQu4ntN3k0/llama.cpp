...
bool llama_model::load_tensors_pipo(llama_model_loader & ml) {
    ...
    for (int il = 0; il < n_layer; ++il) {
        pimpl->dev_layer[il] = {gpu_dev, nullptr};
    }
    ...
    ggml_backend_buffer_type_t buft_dynamic = ggml_backend_dev_buffer_type(devices[0].dev);
    ...
    // create tensors for the weights
    {
        ...
        auto create_tensor = [&](const LLM_TN_IMPL & tn, const std::initializer_list<int64_t> & ne, int flags) -> ggml_tensor * {
            ...
            return ml.create_tensor(
                ...
                tn, ne, flags, params.enable_pipo, weight_map, name_weight_map, ctx_dynamic);
        };
